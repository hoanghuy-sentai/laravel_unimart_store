        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('product.createCat')}}">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <div class="form-group w-100">
                                    <label for="name">Tên danh mục</label>
                                    <input class="form-control" type="text" name="productcatName" id="name">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="productcatStatus" id="public"
                                ...
                                <div class="form-group w-100">
                                    ...
                                    <select name="parent_id" class="form-control" id="">
                                        ...
                                        @foreach ($listProductcats as $item)
                                            <option value="{{$item->id}}">{{str_repeat("-",$item['level']).$item->productcatName}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item->product->count()}}</td>{{-- {{$postcat->post->count()}} --}}
