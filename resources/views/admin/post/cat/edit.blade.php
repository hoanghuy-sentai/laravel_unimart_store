        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{Route('post.cat.update',$data[0]->id)}}">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <div class="form-group w-100">
                                    <label for="name">Tên danh mục</label>
                                    <input class="form-control" type="text" name="catName" value="{{$data[0]->catName}}"
                                        id="name">
                                    @error('catName')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input {{$data[0]->catStatus=='Chờ duyệt'?'checked':''}}
                                        class="form-check-input" type="radio" name="catStatus"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="catStatus" id="waiting"
                                            value="Công khai" {{$data[0]->catStatus=='Công khai'?'checked':''}}>
                                ...
                                <div class="form-group w-100">
                                    ...
                                    <select name="parent_id" class="form-control" id="">
                                        ...
                                        @foreach ($listPostcats as $item)
                                          <option value="{{$item->id}}" {{$data[0]->catName==$item->catName?'selected':''}}>{{str_repeat('-',$item['level']).$item['catName']}} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
