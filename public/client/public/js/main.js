...
//  MAIN MENU
    ...
    $('#category-product-wp .list-item >ul> li').find('.sub-menu').after('<i class="fa fa-angle-right arrow" aria-hidden="true"></i>');
    $('#category-product-wp .list-item > ul.sub-menu').removeClass('sub-menu');
    $('#category-product-wp .list-item  ul.sub-menu:empty').next().remove();
    $('#category-product-wp .list-item  ul.sub-menu:empty').remove();
//  TAB
    tab();
...
function tab() {
    ...
    // $('#detailDec').show(100,function(){
    //     alert("ok");
    // })
    $('#detailDec').slideToggle(1000,function(){  })
})
}
